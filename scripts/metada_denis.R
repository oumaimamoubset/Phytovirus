...
# 
# readxl::read_excel("Data/Echantillonnage EDGG 21_CAM.xlsx",
#                    sheet = "EDGG1",
#                    col_names = FALSE,
#                    n_max = 1) %>%
#   pull() %>%
...
#   ungroup() %>%
#   mutate(`Sample code` = str_remove(`Sample code`, ".* "),
#          `Sample code` = str_pad(`Sample code`, width = 2,
#                             side = c("left"),
#                             pad = "0"),
#          `Sample code` = paste0(sample_code_prefix, `Sample code`),
#          `Sample code` = paste0(`Sample code`, "00")) -> other_metadata
# 
# #Add date----
# readxl::read_xlsx("Data/Echantillonnage EDGG 21_CAM.xlsx",
#                    sheet = "EDGG1",
#                    col_names = FALSE,
#                    skip = 1,
#                    n_max = 1) %>%
...
# #Assemble everything----
# 
# metadata_for_Denis <- left_join(x=metadata_for_Denis, y=other_metadata,by=c("Sample code"))
